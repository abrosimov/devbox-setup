...
from _agy_lib import env, io_json

SETTINGS_RELATIVE: Final[str] = ".gemini/antigravity-cli/settings.local.json"
...
BASE_DENY: Final[list[str]] = [
    ...
    "Bash(gh pr merge *)",
    "Bash(gh issue close *)",
    # WARNING: path-scoped file rules must use Edit(...) — Antigravity CLI's file
...
BASE_ALLOW: Final[list[str]] = [
    ...
    "Bash(git worktree list)",
    "Bash(.gemini/antigravity-cli/bin/*)",
    "Bash(ls *)",
    "Bash(ls)",
    "Bash(test *)",
    "Bash([ -f *)",
...
USAGE: Final[str] = (
    "Usage: agy_fix_perms.py [--with-git] [--go] [--python] [--node] [--all] [--no-detect]\n"
    "  Inject/merge permissions into .gemini/antigravity-cli/settings.local.json\n"
    "\n"
    "Options:\n"
