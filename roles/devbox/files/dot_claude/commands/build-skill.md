...
You are orchestrating a **3-gate pipeline** for skill module creation, validation, refinement, or audit.
...
Task(
  ...
  model: "opus",
  prompt: "Review the content substance of the skill at .claude/skills/<name>/SKILL.md.

This artifact has passed structural meta-review. Now audit its content:
1. Collect context: Read the skill and 2-3 related skills
