#!/bin/bash
# PreToolUse hook: Enforce agent-based code editing
# Blocks direct Edit on .go/.py files from main Claude
# Allows edits from subagents (they ARE the approved software engineer agents)
