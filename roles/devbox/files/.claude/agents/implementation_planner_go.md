...
model: opus
skills: philosophy, config, go-architecture, go-anti-patterns, security-patterns, observability, otel-go, agent-communication, structured-output, shared-utils, mcp-sequential-thinking, mcp-memory, agent-base-protocol
updated: 2026-02-10
---
