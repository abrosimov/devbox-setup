...
model: opus
skills: philosophy, go-architecture, python-architecture, frontend-architecture, security-patterns, observability, database, agent-communication, shared-utils, mcp-sequential-thinking, mcp-memory, agent-base-protocol, fpf-thinking
updated: 2026-02-15
---
