...
- `domain_model.md` — Formal DDD model (from Domain Modeller, if exists). Read the bounded contexts' aggregates, invariants, state machine, and system constraints to inform table design and constraints.
